...
export default function Repentance() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-rose-700 via-rose-600 to-rose-800 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 p-4 md:p-6 transition-colors duration-300 transition-colors duration-300">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <div className="inline-flex items-center gap-2 bg-gradient-to-r from-rose-100 to-pink-100 dark:from-slate-800/80 dark:to-slate-700/80 px-6 py-3 rounded-full mb-6 transition-colors duration-300 transition-colors duration-300">
            <Heart className="w-5 h-5 text-rose-600 dark:text-rose-400 transition-colors duration-300" />
            <span className="text-rose-800 dark:text-rose-300 font-semibold transition-colors duration-300">التوبة</span>
          </div>
          ...
          <div className="max-w-4xl mx-auto bg-gradient-to-br from-amber-50 to-amber-100 dark:from-slate-800/50 dark:to-slate-700/50 rounded-3xl p-6 md:p-10 shadow-2xl border-2 border-amber-200 dark:border-slate-600 mb-8 transition-colors duration-300 transition-colors duration-300">
            ...
            <p className="text-lg text-rose-700 dark:text-rose-400 font-semibold transition-colors duration-300">سورة الزمر - آية 53</p>
          </div>
              ...
              <Link to={section.link}>
                <Card className={`group hover:shadow-2xl transition-all duration-500 border-0 bg-gradient-to-br ${section.color} overflow-hidden h-full hover:-translate-y-2 rounded-3xl relative`}>
                  ...
                  <CardContent className="p-6 md:p-8 text-center">
                    ...
                    <h3 className="text-base md:text-lg font-bold text-gray-800 dark:text-white mb-2 transition-colors duration-300">{section.title}</h3>
                    <p className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed transition-colors duration-300">{section.description}</p>
                  </CardContent>
                </Card>
              </Link>
            </motion.div>
        ...
        >
          <Card className="border-0 shadow-2xl bg-white dark:bg-slate-800/95 dark:bg-slate-800/50 backdrop-blur-sm rounded-3xl overflow-hidden mb-8 transition-colors duration-300 transition-colors duration-300">
            <CardHeader className="bg-gradient-to-r from-rose-500 to-rose-600 dark:from-rose-600 dark:to-rose-700 text-white p-6 md:p-8 transition-colors duration-300">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {steps.map((step, index) => (
                  <motion.div
                    ...
                    className="flex gap-4 items-start bg-gradient-to-br from-rose-50 to-pink-50 dark:from-slate-700/50 dark:to-slate-600/50 p-6 rounded-2xl shadow-md transition-colors duration-300 transition-colors duration-300"
                  >
                    <div className="w-12 h-12 rounded-full bg-gradient-to-br from-rose-400 to-rose-600 dark:from-rose-500 dark:to-rose-700 flex items-center justify-center flex-shrink-0 shadow-lg transition-colors duration-300">
                      <span className="text-white font-bold text-lg">{index + 1}</span>
                    </div>
                    <div>
                      <h4 className="text-lg font-bold text-gray-900 dark:text-white mb-2 transition-colors duration-300">{step.title}</h4>
                      <p className="text-gray-700 dark:text-gray-300 leading-relaxed transition-colors duration-300">{step.description}</p>
                    </div>
                  </motion.div>
                ))}
              </div>

              <div className="mt-8 p-6 bg-gradient-to-br from-emerald-50 to-teal-50 dark:from-slate-700/30 dark:to-slate-600/30 rounded-2xl border-2 border-emerald-200 dark:border-slate-600 transition-colors duration-300 transition-colors duration-300">
                <div className="flex items-start gap-3">
                  <Sparkles className="w-6 h-6 text-emerald-600 dark:text-teal-400 flex-shrink-0 mt-1 transition-colors duration-300" />
                  <div>
                    <h4 className="text-lg font-bold text-emerald-900 dark:text-teal-300 mb-2 transition-colors duration-300">تذكر دائماً</h4>
                    <p className="text-emerald-800 dark:text-gray-300 leading-relaxed transition-colors duration-300">
                      "إِنَّ اللَّهَ يُحِبُّ التَّوَّابِينَ وَيُحِبُّ الْمُتَطَهِّرِينَ" - سورة البقرة: 222
                    </p>
                    <p className="text-emerald-700 dark:text-gray-400 mt-2 transition-colors duration-300">
        ...
        >
          <Card className="border-0 shadow-2xl bg-gradient-to-br from-rose-500 to-pink-600 dark:from-slate-800/80 dark:to-slate-700/80 text-white overflow-hidden relative rounded-3xl transition-colors duration-300 transition-colors duration-300">
            ...
            <CardContent className="p-8 md:p-12 text-center relative z-10">
              ...
              <p className="text-lg md:text-xl text-rose-50 dark:text-gray-300 mb-8 max-w-2xl mx-auto transition-colors duration-300">
                فريقنا من المفتين والدعاة جاهز لمساعدتك في رحلة التوبة
              </p>
              <Button
                onClick={() => setShowContactModal(true)}
                size="lg"
                className="bg-white dark:bg-slate-800 text-rose-600 hover:bg-rose-50 dark:bg-slate-700 dark:text-rose-300 dark:hover:bg-slate-600 text-lg md:text-xl px-8 md:px-10 py-6 md:py-7 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105 transition-colors duration-300"
              >
